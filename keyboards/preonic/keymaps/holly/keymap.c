...
[_BASE] = LAYOUT_preonic_grid(
  ...
  KC_LCTL, KC_LGUI, KC_APP,  KC_LALT, LOWER,   KC_SPC,  KC_RSFT, RAISE,   KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT
),
...
[_ADJUST] = LAYOUT_preonic_grid(
  BASE,    COLEMAK, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,
  _______, RESET,   DEBUG,   _______, _______, _______, _______, _______, INFO,    _______, _______, _______,
  _______, _______, _______, _______, _______, _______, _______, KC_HOME, KC_PGDN, KC_PGUP, KC_END,  _______,
  _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,
  _______, _______, _______, _______, _______, _______, _______, _______, KC_RALT, KC_RGUI, KC_APP,  KC_RCTL
)
...
bool process_record_user(uint16_t keycode, keyrecord_t *record) {
  switch (keycode) {
        ...
        case INFO:
            if (record->event.pressed) {
                SEND_STRING("QMK Firmware v" QMK_VERSION ", built " QMK_BUILDDATE);
            }
            break;
      }
    return true;
