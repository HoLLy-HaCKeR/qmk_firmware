 ...
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * | Ctrl | Brite| GUI  | Alt  |Lower | Spce | Shft |Raise | Left | Down |  Up  |Right |
 * `-----------------------------------------------------------------------------------'
 */
[_BASE] = LAYOUT_preonic_grid(
  ...
  KC_LCTL, BACKLIT, KC_LGUI, KC_LALT, LOWER,   KC_SPC,  KC_LSFT, RAISE,   KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT
),
 ...
 * |------+------+------+------+------+-------------+------+------+------+------+------|
 * |      | Clic |Aud cy|Aud on|AudOff|      |      | Home | PgDn | PgUp | End  |      |
 * |------+------+------+------+------+------|------+------+------+------+------+------|
...
[_ADJUST] = LAYOUT_preonic_grid(
  ...
  _______, CK_TOGG, MU_MOD,  AU_ON,   AU_OFF,  _______, _______, KC_HOME, KC_PGDN, KC_PGUP, KC_END,  _______,
